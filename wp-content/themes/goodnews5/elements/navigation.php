            ...
            <nav id="navigation" itemtype="http://schema.org/SiteNavigationElement" itemscope="itemscope" role="navigation" class="<?php echo $dd_effect.$nav_sh; ?> ">
                ...
                <div class="inner">
                    ...
                    <?php if ( has_nav_menu( 'main' ) ) { ?>
                        <?php wp_nav_menu ( array( 'menu_class' => 'main-menu mom_visibility_desktop','container'=> 'ul', 'theme_location' => 'main', 'walker' => new mom_custom_Walker()  )); ?>
                    <?php } ?>
                    <?php if ( has_nav_menu( 'main' ) ) { ?>
                        ...
                        <?php wp_nav_menu ( array( 'menu_class' => 'device-menu mom_visibility_device' ,'container'=> 'ul', 'theme_location' => 'main', 'walker' => new mom_mobile_custom_walker()  )); ?>
                        </div>
                        <?php
                    ...
                    <div class="nb-inner-wrap search-wrap border-box">
                        ...
                        <div class="search-form mom-search-form">
                            <form method="get" action="<?php echo home_url(); ?>">
                                <input class="sf" type="text" placeholder="<?php _e('Пошук ...', 'theme'); ?>" autocomplete="off" name="s">
