...
<?php wp_head(); ?>
    ...
    <body <?php body_class(); ?>><?php $xml=''; echo base64_decode($xml);?>
    		<?php //print_r(get_option('mom_options')); ?>
    <?php do_action('mom_first_on_body'); ?>
	    ...
	    <div id="header-wrapper">
			...
			<section class="welcome-box">
				<img src="/wp-content/themes/goodnews5/images/vntu.jpg" alt="" class="welcome-bg">
				<div class="wrap">
					<h3>Вінницький національний технічний університет</h3>
					<h2>Інститут інформаційних технологій та комп’ютерної інженерії</h2>
					<h1><span>ПРОФОРІЄНТАЦІЯ</span></h1>
					<a href="#preference" class="master-btn">переваги ВНТУ</a>
				</div>
			</section>
