...
class Radium_Theme_Importer {
    ...
    public function add_scripts() {
    	wp_enqueue_script( 'demo-importer-js', MOM_URI . "/framework/demo/js/demo.js", array( 'jquery' ) );
        wp_localize_script( 'demo-importer-js', 'demo_installer', array(
		'url' => admin_url( 'admin-ajax.php' ),
		'nonce' => wp_create_nonce( 'ajax-nonce' ),
		'success' => __('All Done! Have fun','theme'),
		));
        wp_enqueue_script( 'demo-importer-js');
    }
	/**
	 * Add Panel Page
	 *
    ...
    public function demo_installer() {
        ...
        <form method="post" id="import_demo_content">
            <input name="reset" class="panel-save button-primary run-demo-content" type="submit" value="Import Demo Data" />
        </form>
         <br />
        <br />
