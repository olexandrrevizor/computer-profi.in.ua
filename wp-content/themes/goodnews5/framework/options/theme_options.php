...
if (!function_exists('mom_gn_import_demo')):
    ...
    <div class="mom_demo_import_wrap">
        <div class="mom_demo_import_item">
            <a href="#" class="run-demo-content demo-item-image"><div class="bt"><span><?php _e('Click to import', 'theme'); ?></span></div><img src="<?php echo MOM_URI; ?>/framework/options/momizat/images/demo/default.png"></a>
            <div class="mom_demo_import_item_details">
                <p><strong><?php _e('what you get:', 'theme'); ?></strong> <a href="http://www.momizat.com/theme/goodnews/" target="_blank"><?php _e('Online Demo'); ?></a></p>
